...
os.system(
    "openapi-generator-cli generate -g typescript-fetch -t templates -i http://127.0.0.1:8000/openapi/"
)
...
with (
    open(TEMPLATE_FILE_NAME, "a") as template_file,
    open(OVERRIDE_FILE_NAME, "r") as override_file,
):
...
os.system(
    f"openapi-generator-cli generate -g typescript-fetch -t templates -i http://127.0.0.1:8000/openapi/ --global-property models={':'.join(MODELS)}"
)
