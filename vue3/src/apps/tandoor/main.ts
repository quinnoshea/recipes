...
let routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'cosmetic',
        component: () => import('@/components/settings/CosmeticSettings.vue'),
        name: 'CosmeticSettings',
        meta: { title: 'Settings' },
      },
      {
        path: 'shopping',
        component: () => import('@/components/settings/ShoppingSettings.vue'),
        name: 'ShoppingSettings',
        meta: { title: 'Settings' },
      },
      {
        path: 'meal-plan',
        component: () => import('@/components/settings/MealPlanSettings.vue'),
        name: 'MealPlanSettings',
        meta: { title: 'Settings' },
      },
      {
        path: 'search',
        component: () => import('@/components/settings/SearchSettings.vue'),
        name: 'SearchSettings',
        meta: { title: 'Settings' },
      },
      {
        path: 'space',
        component: () => import('@/components/settings/SpaceSettings.vue'),
        name: 'SpaceSettings',
        meta: { title: 'Settings' },
      },
      {
        path: 'space-members',
        component: () => import('@/components/settings/SpaceMemberSettings.vue'),
        name: 'SpaceMemberSettings',
        meta: { title: 'Settings' },
      },
      {
        path: 'user-space',
        component: () => import('@/components/settings/UserSpaceSettings.vue'),
        name: 'UserSpaceSettings',
        meta: { title: 'Settings' },
      },
      {
        path: 'open-data-import',
        component: () => import('@/components/settings/OpenDataImportSettings.vue'),
        name: 'OpenDataImportSettings',
        meta: { title: 'Settings' },
      },
      {
        path: 'export',
        component: () => import('@/components/settings/ExportDataSettings.vue'),
        name: 'ExportDataSettings',
        meta: { title: 'Settings' },
      },
      {
        path: 'api',
  ...
  },
  {
    ...
    meta: { title: 'Shopping_list' },
  },
  {
    path: '/mealplan',
    component: MealPlanPage,
    name: 'MealPlanPage',
    meta: { title: 'Meal_Plan' },
  },
  {
    path: '/books',
  ...
  {
    path: '/book/:bookId',
    component: () => import('@/pages/BookViewPage.vue'),
    name: 'BookViewPage',
    props: true,
    meta: { title: 'Book' },
  },
  ...
  {
    path: '/edit/:model/:id?',
    component: () => import('@/pages/ModelEditPage.vue'),
    props: true,
    name: 'ModelEditPage',
  },
  {
...

  {
    ...
    component: () => import('@/pages/IngredientEditorPage.vue'),
    name: 'IngredientEditorPage',
    meta: { title: 'Ingredient Editor' },
  },
  {
    path: '/property-editor',
    component: () => import('@/pages/PropertyEditorPage.vue'),
    name: 'PropertyEditorPage',
    meta: { title: 'Property_Editor' },
  },

  {
    path: '/space-setup',
    component: () => import('@/pages/SpaceSetupPage.vue'),
    name: 'SpaceSetupPage',
  },
