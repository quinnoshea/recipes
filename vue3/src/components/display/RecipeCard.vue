<template>
  <template v-if="!props.loading">
    <router-link
      :to="{ name: 'RecipeViewPage', params: { id: props.recipe.id } }"
      :target="linkTarget"
    >
      <recipe-image
    ...
    <div class="ml-3">
      ...
      <keywords-component
        variant="outlined"
        :keywords="props.recipe.keywords"
        :max-keywords="3"
        v-if="props.showKeywords"
      >
        <template #prepend>
    ...
    >
      ...
      >
        <template v-slot:activator="{ props }">
          <recipe-image height="70%" width="100%" :recipe="props.recipe"> </recipe-image>
