...
export function useNavigation() {
  ...
  function getNavigationDrawer() {
    let navigation = [
      ...
      },
      {
        ...
        prependIcon: '$search',
        title: t('Search'),
        to: { name: 'SearchPage', params: {} },
      },
      {
        component: VListItem,
        prependIcon: '$mealplan',
        title: t('Meal_Plan'),
        to: { name: 'MealPlanPage', params: {} },
      },
      {
        component: VListItem,
        prependIcon: '$shopping',
        title: t('Shopping_list'),
        to: { name: 'ShoppingListPage', params: {} },
      },
      {
        component: VListItem,
      ...
      },
      {
        ...
        prependIcon: '$books',
        title: t('Books'),
        to: { name: 'BooksPage', params: {} },
      },
      {
        component: VListItem,
        prependIcon: 'fa-solid fa-folder-tree',
        title: t('Database'),
        to: { name: 'DatabasePage', params: {} },
      },
    ]
  ...
  function getBottomNavigation() {
    let navigation = [
      {
        component: VListItem,
        prependIcon: 'fa-solid fa-sliders',
        title: t('Settings'),
  ...
  function getUserNavigation() {
    ...
    navigation.push({
      component: VListItem,
      prependIcon: 'fa-solid fa-question',
      title: t('Help'),
      to: { name: 'HelpPage', params: {} },
    })

    if (useUserPreferenceStore().userSettings.user.isSuperuser) {
      navigation.push({
        component: VListItem,
        prependIcon: 'fa-solid fa-shield',
        title: t('Admin'),
        href: useDjangoUrls().getDjangoUrl('admin'),
      })
    }
    ...
    if (useUserPreferenceStore().spaces.length > 1) {
      ...
      useUserPreferenceStore().spaces.forEach((space) => {
        navigation.push({
          component: VListItem,
          prependIcon:
            useUserPreferenceStore().activeSpace.id == space.id ?
    ...
    navigation.push({
      component: VListItem,
      prependIcon: 'fa-solid fa-arrow-right-from-bracket',
      title: t('Logout'),
      href: useDjangoUrls().getDjangoUrl('accounts/logout'),
    })
