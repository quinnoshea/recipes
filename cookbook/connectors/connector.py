...
class ShoppingListEntryDTO:
    ...
    @staticmethod
    def try_create_from_entry(
        instance: ShoppingListEntry,
    ) -> Optional["ShoppingListEntryDTO"]:
        ...
        return ShoppingListEntryDTO(
            ...
            base_unit=(
                instance.unit.base_unit
                if instance.unit and instance.unit.base_unit
                else None
            ),
...
class Connector(ABC):
    ...
    async def on_shopping_list_entry_created(
        self, instance: ShoppingListEntryDTO
    ) -> None:
        pass
