    ...
    def get_recipe_from_file(self, file):
        ...
        for line in file.replace("\r", "").split("\n"):
            if line.strip() != "":
                ...
                if "Serves:" in line:
                    fields["servings"] = parse_servings(
                        line.replace("Serves:", "").strip()
                    )
                if "Source:" in line:
                ...
                if "Prep Time:" in line:
                    fields["working_time"] = parse_time(
                        line.replace("Prep Time:", "").strip()
                    )
                if "Cook Time:" in line:
                    fields["waiting_time"] = parse_time(
                        line.replace("Cook Time:", "").strip()
                    )
                if "Tags:" in line:
