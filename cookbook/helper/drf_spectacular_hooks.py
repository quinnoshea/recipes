...
def custom_postprocessing_hook(result, generator, request, public):
    for c in result["components"]["schemas"].keys():
        ...
        if (
            "properties" in result["components"]["schemas"][c]
            and "id" in result["components"]["schemas"][c]["properties"]
        ):
            ...
            if (
                "required" in result["components"]["schemas"][c]
                and "id" in result["components"]["schemas"][c]["required"]
            ):
