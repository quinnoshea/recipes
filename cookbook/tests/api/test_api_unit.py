...
def ing_1_s1(obj_1, space_1, u1_s1):
    return Ingredient.objects.create(
        unit=obj_1, food=random_food(space_1, u1_s1), space=space_1
    )
...
def ing_2_s1(obj_2, space_1, u1_s1):
    return Ingredient.objects.create(
        unit=obj_2, food=random_food(space_1, u1_s1), space=space_1
    )
...
def ing_3_s2(obj_3, space_2, u2_s2):
    return Ingredient.objects.create(
        unit=obj_3, food=random_food(space_2, u2_s2), space=space_2
    )
...
def sle_2_s1(obj_2, u1_s1, space_1):
    return ShoppingListEntry.objects.create(
        unit=obj_2,
        food=random_food(space_1, u1_s1),
        created_by=auth.get_user(u1_s1),
        space=space_1,
...
def sle_3_s2(obj_3, u2_s2, space_2):
    e = ShoppingListEntry.objects.create(
        unit=obj_3,
        food=random_food(space_2, u2_s2),
        created_by=auth.get_user(u2_s2),
        space=space_2,
    )
    return e
...
def test_merge(
    ...
    r = u1_s1.put(reverse(MERGE_URL, args=[obj_2.id, 9999]))
    assert r.status_code == 404
